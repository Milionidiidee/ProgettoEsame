...
<body>
    <nav id="mynavbar" class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark menu">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <a id="link-carrello" href="http://localhost/PW%202020/progettoesame/carrello.php" class="nav-item text-light ml-auto">
	...
	<main class="container">
      <h1 id="alt">Ehi ehi! Dove vai? Password per piacere!</h1>
      <form id="login" method="post">
          <div class="row">
            <label class="col-12 col-sm-6" class="row" for="password">Password</label>
